...
void display(void)							/*DISPLAY function*/
{
	...
	if(wel==0 || wel==1)
	{
		...
		drawstring(8*wh/45, 40*wh/45, 0.0, "DESIGN AND IMPLEMENTION OF PAINT BRUSH APPLICATION");
		...
		drawstring(8*wh/45, 29*wh/45, 0.0, "SHUBHI");
		drawstring(8*wh/45, 27*wh/45, 0.0, "111338");


		drawstring(35*wh/45, 29*wh/45, 0.0, "AMY");
		drawstring(35*wh/45, 27*wh/45, 0.0, "111240");



		drawstring(20*wh/45, 20*wh/45, 0.0, "SUBMITTED TO:");

		drawstring(5*wh/45, 17*wh/45, 0.0, "KAPIL SAINI");
		drawstring(5*wh/45, 15*wh/45, 0.0, "LECTURER, Dept. of CSE");
		drawstring(5*wh/45, 13*wh/45, 0.0, "JUIT");
	...
	if(count>1)
	{
		...
		glDrawPixels(wx-wy/10-2, wy-wy/10-wy/20-1, GL_RGB, GL_UNSIGNED_BYTE, image); /* to write pixels into the selected buffer */
